 ...
 */
    #[no_mangle]
    static gtk_primary_selection_device_manager_interface: wl_interface;
    /* *
 ...
 */
    #[no_mangle]
    static gtk_primary_selection_device_interface: wl_interface;
    /* *
 ...
 */
    #[no_mangle]
    static gtk_primary_selection_offer_interface: wl_interface;
    /* *
 ...
 */
    #[no_mangle]
    static gtk_primary_selection_source_interface: wl_interface;
    #[no_mangle]
...
#[derive ( Copy, Clone )]
#[repr(C)]
pub struct wlr_gtk_primary_selection_device {
    pub manager: *mut wlr_gtk_primary_selection_device_manager,
    pub seat: *mut wlr_seat,
    pub link: wl_list,
    pub resources: wl_list,
    pub offers: wl_list,
...
#[derive ( Copy, Clone )]
#[repr(C)]
pub struct gtk_primary_selection_device_manager_interface {
...
#[derive ( Copy, Clone )]
#[repr(C)]
pub struct gtk_primary_selection_device_interface {
...
#[derive ( Copy, Clone )]
#[repr(C)]
pub struct gtk_primary_selection_source_interface {
...
#[derive ( Copy, Clone )]
#[repr(C)]
pub struct gtk_primary_selection_offer_interface {
 ...
 */
#[inline]
unsafe extern "C" fn gtk_primary_selection_device_send_data_offer(mut resource_:
                                                                      *mut wl_resource,
                                                                  mut offer:
                                                                      *mut wl_resource) {
 ...
 */
#[inline]
unsafe extern "C" fn gtk_primary_selection_device_send_selection(mut resource_:
                                                                     *mut wl_resource,
                                                                 mut id:
                                                                     *mut wl_resource) {
 ...
 */
#[inline]
unsafe extern "C" fn gtk_primary_selection_offer_send_offer(mut resource_:
                                                                *mut wl_resource,
                                                            mut mime_type:
                                                                *const libc::c_char) {
 ...
 */
#[inline]
unsafe extern "C" fn gtk_primary_selection_source_send_send(mut resource_:
                                                                *mut wl_resource,
                                                            mut mime_type:
                                                                *const libc::c_char,
                                                            mut fd: int32_t) {
 ...
 */
#[inline]
unsafe extern "C" fn gtk_primary_selection_source_send_cancelled(mut resource_:
                                                                     *mut wl_resource) {
    wl_resource_post_event(resource_, 1i32 as uint32_t);
}
unsafe extern "C" fn device_from_offer_resource(mut resource:
                                                    *mut wl_resource)
 -> *mut wlr_gtk_primary_selection_device {
    if wl_resource_instance_of(resource,
                               &gtk_primary_selection_offer_interface,
                               &offer_impl as
                                   *const gtk_primary_selection_offer_interface
                                   as *const libc::c_void) != 0 {
    } else {
        __assert_fail(b"wl_resource_instance_of(resource, &gtk_primary_selection_offer_interface, &offer_impl)\x00"
                          as *const u8 as *const libc::c_char,
                      b"../types/wlr_gtk_primary_selection.c\x00" as *const u8
                          as *const libc::c_char, 21i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 90],
                                                &[libc::c_char; 90]>(b"struct wlr_gtk_primary_selection_device *device_from_offer_resource(struct wl_resource *)\x00")).as_ptr());
    };
...
unsafe extern "C" fn offer_handle_receive(mut client: *mut wl_client,
                                          ...
                                          mut fd: int32_t) {
    let mut device: *mut wlr_gtk_primary_selection_device =
...
static mut offer_impl: gtk_primary_selection_offer_interface =
    unsafe {
        {
            let mut init =
                gtk_primary_selection_offer_interface{receive:
...
unsafe extern "C" fn create_offer(mut device_resource: *mut wl_resource,
    ...
    let mut resource: *mut wl_resource =
        wl_resource_create(client, &gtk_primary_selection_offer_interface,
...
unsafe extern "C" fn client_data_source_from_resource(mut resource:
 ...
 -> *mut client_data_source {
    if wl_resource_instance_of(resource,
                               ...
                               &source_impl as
                                   *const gtk_primary_selection_source_interface
                                   as *const libc::c_void) != 0 {
    } else {
        __assert_fail(b"wl_resource_instance_of(resource, &gtk_primary_selection_source_interface, &source_impl)\x00"
                          as *const u8 as *const libc::c_char,
                      b"../types/wlr_gtk_primary_selection.c\x00" as *const u8
    ...
    if (*source).finalized {
        _wlr_log(WLR_DEBUG,
                 b"[%s:%d] Offering additional MIME type after set_selection\x00"
                     as *const u8 as *const libc::c_char,
                 b"../types/wlr_gtk_primary_selection.c\x00" as *const u8 as
...
static mut source_impl: gtk_primary_selection_source_interface =
    unsafe {
        {
            let mut init =
                gtk_primary_selection_source_interface{offer:
...
unsafe extern "C" fn device_from_resource(mut resource: *mut wl_resource)
 -> *mut wlr_gtk_primary_selection_device {
    if wl_resource_instance_of(resource,
                               ...
                               &device_impl as
                                   *const gtk_primary_selection_device_interface
                                   as *const libc::c_void) != 0 {
    } else {
        __assert_fail(b"wl_resource_instance_of(resource, &gtk_primary_selection_device_interface, &device_impl)\x00"
                          as *const u8 as *const libc::c_char,
                      b"../types/wlr_gtk_primary_selection.c\x00" as *const u8
                          as *const libc::c_char, 196i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 84],
                                                &[libc::c_char; 84]>(b"struct wlr_gtk_primary_selection_device *device_from_resource(struct wl_resource *)\x00")).as_ptr());
    };
    return wl_resource_get_user_data(resource) as
               *mut wlr_gtk_primary_selection_device;
}
...
static mut device_impl: gtk_primary_selection_device_interface =
    unsafe {
        {
            let mut init =
                gtk_primary_selection_device_interface{set_selection:
...
unsafe extern "C" fn device_resource_send_selection(mut resource:
    ...
    if !source.is_null() {
        ...
        gtk_primary_selection_device_send_selection(resource,
...
unsafe extern "C" fn get_or_create_device(mut manager:
                                              *mut wlr_gtk_primary_selection_device_manager,
                                          mut seat: *mut wlr_seat)
 -> *mut wlr_gtk_primary_selection_device {
    let mut device: *mut wlr_gtk_primary_selection_device =
        0 as *mut wlr_gtk_primary_selection_device;
    device =
    ...
    device =
        calloc(1i32 as libc::c_ulong,
               ::std::mem::size_of::<wlr_gtk_primary_selection_device>() as
                   libc::c_ulong) as *mut wlr_gtk_primary_selection_device;
    if device.is_null() { return 0 as *mut wlr_gtk_primary_selection_device }
 ...
 -> *mut wlr_gtk_primary_selection_device_manager {
    if wl_resource_instance_of(resource,
                               ...
                               &device_manager_impl as
                                   *const gtk_primary_selection_device_manager_interface
                                   as *const libc::c_void) != 0 {
    } else {
        __assert_fail(b"wl_resource_instance_of(resource, &gtk_primary_selection_device_manager_interface, &device_manager_impl)\x00"
                          as *const u8 as *const libc::c_char,
                      b"../types/wlr_gtk_primary_selection.c\x00" as *const u8
                          as *const libc::c_char, 367i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 93],
                                                &[libc::c_char; 93]>(b"struct wlr_gtk_primary_selection_device_manager *manager_from_resource(struct wl_resource *)\x00")).as_ptr());
    };
    return wl_resource_get_user_data(resource) as
               *mut wlr_gtk_primary_selection_device_manager;
}
...
unsafe extern "C" fn device_manager_handle_get_device(mut client:
    ...
    let mut manager: *mut wlr_gtk_primary_selection_device_manager =
    ...
    let mut version: uint32_t =
        wl_resource_get_version(manager_resource) as uint32_t;
    let mut resource: *mut wl_resource =
        wl_resource_create(client, &gtk_primary_selection_device_interface,
                           version as libc::c_int, id);
    if resource.is_null() {
        wl_resource_post_no_memory(manager_resource);
        return
...
static mut device_manager_impl: gtk_primary_selection_device_manager_interface
       =
    unsafe {
        {
            let mut init =
                gtk_primary_selection_device_manager_interface{create_source:
...
unsafe extern "C" fn primary_selection_device_manager_bind(mut client:
                                                           ...
                                                           mut id: uint32_t) {
    let mut manager: *mut wlr_gtk_primary_selection_device_manager =
        data as *mut wlr_gtk_primary_selection_device_manager;
    let mut resource: *mut wl_resource =
 ...
 */
// wlr_gtk_primary_selection_device::link
/* *
 * A device is a per-seat object used to set and get the current selection.
 */
// wlr_gtk_primary_selection_device_manager::devices
// wl_resource_get_link
// wl_resource_get_link
#[no_mangle]
pub unsafe extern "C" fn wlr_gtk_primary_selection_device_manager_create(mut display:
                                                                             *mut wl_display)
 -> *mut wlr_gtk_primary_selection_device_manager {
    let mut manager: *mut wlr_gtk_primary_selection_device_manager =
        calloc(1i32 as libc::c_ulong,
               ::std::mem::size_of::<wlr_gtk_primary_selection_device_manager>()
                   as libc::c_ulong) as
            *mut wlr_gtk_primary_selection_device_manager;
    if manager.is_null() {
        return 0 as *mut wlr_gtk_primary_selection_device_manager
    }
    (*manager).global =
